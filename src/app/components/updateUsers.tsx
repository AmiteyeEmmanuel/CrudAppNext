...
export default function UpdateUsers() {
    ...
    return(
        <form action="" className="grid lg:grid-cols-2 w-4/6 gap-4" onSubmit={handleSubmit}>
            ...
            <button className="flex justify-center text-md w-2/6  bg-sky-600 text-white px-4 py-2 border rounded-md hover:bg-gray-900">Update
            <span className="px-1"><BiBrush size={23}/> </span>
            </button>
        </form>
    )
}